...
* :find - with two different retrieval approaches:
  ...
  * Hash - {find parameters}[http://api.rubyonrails.org/classes/ActiveRecord/Base.html#M002208]
* :count - like find
* :window_offset - An integer determining the page number
* :max_items_per_page - An integer determining the max amount of items per page. It's useful when it receve items_per_page parameter from request
* :min_items_per_page 
* :min_window_offset 
* :max_window_offset 
